...
function fGeometrie(text, dateiname, vorgaben){
  ...
  /* Kernloch -> Gewinde (19.09.2026): nur der exakte Regelkernloch-Durchmesser. */
  bo.forEach(b => { const g = (typeof fGewindeAusKernloch === 'function') ? fGewindeAusKernloch(b.d) : null; if(g) b.gewinde = g; });
  d.teil.bohrungen = bo;
